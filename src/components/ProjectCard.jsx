...
const ProjectCard = ({ title, description, tags, links, image }) => {
  return (
    <div className="flex max-w-120 flex-col h-full">
      {/* Proje Görseli */}
      ...
      {/* Başlık */}
      <h3 className="text-2xl font-bold text-[#4c40f7] dark:text-[#AEBCCF] mb-4 font-sans">
        {title}
      </h3>
      ...
      <div className="flex justify-between items-center mt-2">
        <a
          ...
          className="text-[#4c40f7] dark:text-[#afaafe] font-semibold underline underline-offset-4 hover:text-[#1e14aa] dark:hover:text-[#5e56c9]"
        >
          {links.github.title}
        </a>
        <a
