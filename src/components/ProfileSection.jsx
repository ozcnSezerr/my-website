...
const ProfileSection = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 pb-8 pt-0 bg-white font-sans">
      {/* title */}
      ...
      <div className="flex flex-col md:flex-row md:space-x-12 space-y-12 md:space-y-0">
        ...
        <div className="md:w-1/2">
          <h2 className="text-3xl font-semibold text-[#4338CA] mb-6">
            {data.en.profileSection.title}
          </h2>

          <div className="grid grid-cols-[160px_1fr] gap-y-4 text-slate-800">
